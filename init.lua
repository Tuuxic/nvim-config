...
-- Saving keymaps
vim.keymap.set('n', '<leader>w', ':w<CR>', { desc = 'Save the file. [W]rite data to disk' })
...
require('lazy').setup({
    ...
    --
    require 'tuuxic.plugins.debug',
    require 'tuuxic.plugins.indent_line',
    require 'tuuxic.plugins.lint',
    require 'tuuxic.plugins.autopairs',
    require 'tuuxic.plugins.neo-tree',
    require 'tuuxic.plugins.gitsigns', -- adds gitsigns recommend keymaps
